...
public class TablesClass extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String table1 = "CREATE TABLE IF NOT EXISTS " + Constants.EMPLOYEE_RECORD + " ("
                + Constants.ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                + Constants.EMP_ID + " TEXT, "
                + Constants.EMP_NAME + " TEXT, "
                + Constants.EMP_AGE + " TEXT, "
                + Constants.EMP_PHOTO_IMAGE + " TEXT) ";
            db.execSQL(table1);
